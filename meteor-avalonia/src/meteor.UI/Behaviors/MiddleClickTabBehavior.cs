...
public static class MiddleClickTabBehavior
{
    public static readonly AttachedProperty<ICommand> CloseCommandProperty =
        AvaloniaProperty.RegisterAttached<Interactive, ICommand>("CloseCommand", typeof(MiddleClickTabBehavior));

    public static readonly AttachedProperty<object> CloseCommandParameterProperty =
        AvaloniaProperty.RegisterAttached<Interactive, object>("CloseCommandParameter", typeof(MiddleClickTabBehavior));

    static MiddleClickTabBehavior()
    {
