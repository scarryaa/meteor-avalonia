...
public class CommandPalette : UserControl
{
    ...
    private readonly ObservableCollection<string> _commands;
    ...
    private void InitializeComponent()
    {
        ...
        {
            if (args.Property.Name == nameof(IsVisible)) CommandPalette_IsVisibleChanged(sender, args);
        };
    }
    ...
    private void ApplyTheme()
    {
        ...
        var styles = new Styles
        {
            new Style(x => x.OfType<ListBox>().Class("command-palette-results"))
            {
                Setters =
                {
                    new Setter(BackgroundProperty, new SolidColorBrush(Color.Parse(theme.BackgroundBrush))),
                    new Setter(ForegroundProperty, new SolidColorBrush(Color.Parse(theme.TextBrush))),
            ...
            new Style(x => x.OfType<TextBox>().Class("command-palette-search"))
            {
                Setters =
                {
                    ...
                    new Setter(FontSizeProperty, 16d)
                }
            },
            new Style(x => x.OfType<TextBox>().Class("command-palette-search").Class(":focus"))
            {
                ...
                {
                    new Setter(BackgroundProperty, new SolidColorBrush(Color.Parse(theme.BackgroundBrush))),
                    new Setter(BorderBrushProperty, new SolidColorBrush(Color.Parse(theme.BorderBrush)))
                }
            },
    ...
    private void SearchBox_TextChanged(object sender, TextChangedEventArgs e)
    {
        ...
        {
            if ("switch theme".Contains(searchText)) _commands.Add("Switch Theme");
        }
        else
        {
    ...
    {
        if (IsVisible) Dispatcher.UIThread.InvokeAsync(() => _searchBox.Focus());
    }
