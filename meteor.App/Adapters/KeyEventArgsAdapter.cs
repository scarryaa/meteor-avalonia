...
public class KeyEventArgsAdapter : IKeyEventArgs
{
    ...
    private Key ConvertKey(Avalonia.Input.Key key)
    {
        return key switch
        {
            ...
            Avalonia.Input.Key.Select => Key.Select,
            Avalonia.Input.Key.Print => Key.Print,
            Avalonia.Input.Key.Execute => Key.Execute,
            Avalonia.Input.Key.PrintScreen => Key.PrintScreen,
            Avalonia.Input.Key.Insert => Key.Insert,
            Avalonia.Input.Key.Delete => Key.Delete,
            Avalonia.Input.Key.Help => Key.Help,
            ...
            Avalonia.Input.Key.LWin => Key.LWin,
            Avalonia.Input.Key.RWin => Key.RWin,
            Avalonia.Input.Key.Apps => Key.Apps,
            Avalonia.Input.Key.Sleep => Key.Sleep,
            ...
            Avalonia.Input.Key.Multiply => Key.Multiply,
            Avalonia.Input.Key.Add => Key.Add,
            Avalonia.Input.Key.Separator => Key.Separator,
            Avalonia.Input.Key.Subtract => Key.Subtract,
            Avalonia.Input.Key.Decimal => Key.Decimal,
            Avalonia.Input.Key.Divide => Key.Divide,
            ...
            Avalonia.Input.Key.Scroll => Key.Scroll,
            ...
            Avalonia.Input.Key.BrowserBack => Key.BrowserBack,
            Avalonia.Input.Key.BrowserForward => Key.BrowserForward,
            Avalonia.Input.Key.BrowserRefresh => Key.BrowserRefresh,
            Avalonia.Input.Key.BrowserStop => Key.BrowserStop,
            Avalonia.Input.Key.BrowserSearch => Key.BrowserSearch,
            Avalonia.Input.Key.BrowserFavorites => Key.BrowserFavorites,
            Avalonia.Input.Key.BrowserHome => Key.BrowserHome,
            ...
            Avalonia.Input.Key.LaunchMail => Key.LaunchMail,
            Avalonia.Input.Key.LaunchApplication1 => Key.LaunchApp1,
            Avalonia.Input.Key.LaunchApplication2 => Key.LaunchApp2,
            Avalonia.Input.Key.OemSemicolon => Key.OemSemicolon,
            Avalonia.Input.Key.OemPlus => Key.OemPlus,
            Avalonia.Input.Key.OemComma => Key.OemComma,
            Avalonia.Input.Key.OemMinus => Key.OemMinus,
            Avalonia.Input.Key.OemPeriod => Key.OemPeriod,
            Avalonia.Input.Key.OemQuestion => Key.OemQuestion,
            Avalonia.Input.Key.OemTilde => Key.OemTilde,
            Avalonia.Input.Key.OemOpenBrackets => Key.OemOpenBrackets,
            Avalonia.Input.Key.OemPipe => Key.OemPipe,
            Avalonia.Input.Key.OemCloseBrackets => Key.OemCloseBrackets,
            Avalonia.Input.Key.OemQuotes => Key.OemQuotes,
            Avalonia.Input.Key.Oem8 => Key.Oem8,
            Avalonia.Input.Key.OemBackslash => Key.OemBackslash,
            Avalonia.Input.Key.Attn => Key.Attn,
            Avalonia.Input.Key.CrSel => Key.CrSel,
            Avalonia.Input.Key.ExSel => Key.ExSel,
            Avalonia.Input.Key.EraseEof => Key.EraseEof,
            Avalonia.Input.Key.Play => Key.Play,
            Avalonia.Input.Key.Zoom => Key.Zoom,
            Avalonia.Input.Key.NoName => Key.NoName,
            Avalonia.Input.Key.Pa1 => Key.Pa1,
            Avalonia.Input.Key.OemClear => Key.OemClear,
            _ => Key.None
        };
    }
}